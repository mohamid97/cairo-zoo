...
class CitySeeder extends Seeder
{
    ...
    [27, 'الكوثر', 'Alkawthar'],
        ...
        foreach ($cities as $city) {
            // Insert into `cities` table and get the inserted ID
            $cityId = DB::table('cities')->insertGetId([
                'code' => $city[0], // Assuming $city[0] is the code
                'gov_id' => $city[0],
            ]);
        
            // Insert Arabic translation into `city_translations`
            DB::table('city_translations')->insert([
                [
                    'small_des' => null, // Replace with your actual field name if different
                    'des' => null, // Replace with your actual field name if different
                    'name' => $city[1], // Arabic name
                    'city_id' => $cityId,
                    'locale' => 'ar',
                ],
            ]);
        
            // Insert English translation into `city_translations`
            DB::table('city_translations')->insert([
                [
                    'small_des' => null, // Replace with your actual field name if different
                    'des' => null, // Replace with your actual field name if different
                    'name' => $city[2], // English name
                    'city_id' => $cityId,
                    'locale' => 'en',
                ],
            ]);
