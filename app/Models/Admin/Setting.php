...
class Setting extends Model implements TranslatableContract
{
    ...
    protected $fillable = ['logo', 'orders' ,'tags', 'points' ,  'stock','favicon','blog_breadcrumb_background' ,'service_details_breadcrumb_background','category_details_breadcrumb_background' , 'blog_details_breadcrumb_background','our_work_breadcrumb_background','home_breadcrumb_background' , 'contact_breadcrumb_background' , 'about_breadcrumb_background' , 'products_breadcrumb_background' , 'categories_breadcrumb_background' , 'services_breadcrumb_background'];
