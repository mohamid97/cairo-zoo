...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('data_entry.products.index', [
            'langs' => $this->langs,
            'products' => $products,
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        try{
            ...
            return redirect()->route('data_entry.products.index');
    ...
    public function edit($id)
    {
        ...
        return view('data_entry.products.update', [
            'langs' => $this->langs,
            'categories' => $categories,
            'brands' => $brands,
            'products' => $products,
    ...
    public function gallery($id){
        ...
        return view('data_entry.products.Gallary' , ['product'=>$product]);
    }
    ...
    public function store_gallery(Request $request, $id)
    {
        ...
        if ($request->has('photos')) {
            foreach ($request->file('photos') as $photo) {
                ...
                $gallery->save();
                LoggerHelper::logAction('upload_gallery', $product, $product->toArray());
    ...
    public function delete_gallery($id){
        ...
        try {
            ...
            LoggerHelper::logAction('delete image from gallery', $gallery, $gallery->toArray());
    ...
    public function store_file($id, Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            LoggerHelper::logAction('upload file product', $product, $product->toArray());
        ...
        return redirect()->route('data_entry.products.files', ['id' => $id]);
