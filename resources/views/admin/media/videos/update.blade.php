                    ...
                    <div class="card-body">
                        @foreach($langs as $lang)
                            <div class="form-group">
                                ...
                                <input type="text" name="name[{{ $lang->code }}]" class="form-control" id="name" placeholder="{{ __('main.enter_name') }}" value="{{ $video->translate($lang->code)->name }}">
                        ...
                        <div class="form-group">
                            ...
                            @if($video->image)
                                <img src="{{ asset('uploads/images/media/videos/' . $video->image) }}" width="150px" height="150px" alt="Current Video Image">
                            @endif
                            @error('photo')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" class="form-control" id="link" placeholder="{{ __('main.enter_link') }}" value="{{ $video->link }}">
                            @error('link')
                        ...
                        <div class="border p-3">
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="des[{{ $lang->code }}]" class="form-control" id="des" placeholder="{{ __('main.enter_des') }}" value="{{ $video->translate($lang->code)->des }}">
                                    @error('des.' . $lang->code)
