                    ...
                    <div class="card-body">
                        @foreach($langs as $lang)
                            <div class="form-group">
                                ...
                                <input type="text" name="name[{{ $lang->code }}]" class="form-control" id="name" placeholder="{{ __('main.enter_name') }}" value="{{ $gallery->translate($lang->code)->name }}">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            @if($gallery->photo)
                                <img src="{{ asset('uploads/images/media/gallery/' . $gallery->photo) }}" width="150px" height="150px" alt="{{ $gallery->translate(app()->getLocale())->title_image }}">
                            @endif
                        ...
                        <div class="border p-3">
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alt_image[{{ $lang->code }}]" class="form-control" id="alt_image" placeholder="{{ __('main.enter_alt_image') }}" value="{{ $gallery->translate($lang->code)->alt_image }}">
                        ...
                        <div class="border p-3">
                            @foreach($langs as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_image[{{ $lang->code }}]" class="form-control" id="title_image" placeholder="{{ __('main.enter_title_image') }}" value="{{ $gallery->translate($lang->code)->title_image }}">
