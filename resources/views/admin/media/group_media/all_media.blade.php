            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('main.media_group_with_details') }}</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-info">
                <div class="card-body">
                    <h2 class="mb-4">{{ __('main.images') }}</h2>
                    <div class="row">
            ...
            <div class="card card-info">
                <div class="card-body">
                    <h2 class="mb-5">{{ __('main.files') }}</h2>
                    <div class="row">
                        @foreach ($media->files as $file)
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2 bg-gradient-dark">
                                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                                        <a style="display: flex; gap: 5px; align-items: center; justify-content: center;" target="_blank" href="{{ asset('uploads/images/media/files/' . $file->file) }}">
                                            <i class="fa fa-file nav-icon" style="color: #1e9db1;"></i>
                                            <h5 style="padding: 0; margin: 0;">{{ $file->name }}</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card card-info">
                <div class="card-body">
                    <h2 class="mb-4">{{ __('main.videos') }}</h2>
                    <div class="row">
                        @foreach ($media->gallerys as $gall)
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2 bg-gradient-dark">
