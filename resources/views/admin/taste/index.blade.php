...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div>
                <a href="{{ route('admin.tastes.add') }}" style="color: #FFF">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <form method="GET" action="{{ route('admin.tastes.index') }}" class="input-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                        <a href="{{ route('admin.tastes.edit', ['id' => $taste->id]) }}">
...
@section('scripts')
    <script>
        function showDeleteTasteModal(tasteId) {
            const url = `{{ url('admin/tastes/delete') }}/${tasteId}`;
