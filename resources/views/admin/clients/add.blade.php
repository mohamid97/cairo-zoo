...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('main.add_new_client') }}</h1> <!-- Translated title -->
                </div>
                <div class="col-sm-6">
                ...
                @csrf <!-- CSRF token -->
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="address" type="text" class="form-control" id="address" placeholder="{{ __('main.enter_address') }}" value="{{ old('address') }}">
                            @error('address')
