        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <!-- Translation key for "Home" -->
                    <li class="breadcrumb-item active">{{ __('main.about_us') }}</li>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{ route('data_entry.about.update') }}" enctype="multipart/form-data">
                @csrf
                <!-- Using Blade directive for CSRF token -->
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name[{{ $lang->code }}]" class="form-control" id="name"
                                    ...
                                    value="{{ ($about) && isset($about->translate($lang->code)->name) ? $about->translate($lang->code)->name : '' }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone"
                                    placeholder="{{ __('main.enter_phone') }}"
                                    value="{{ ($about) ? $about->phone :'' }}">
                                @error('phone')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="mt-3" id="old-image-container">
                                    <img src="{{ asset('uploads/images/about/' . $about->photo) }}" alt="Image"
                    ...
                    <div class="border p-3">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- Translation key for "Alt Image" -->
                                <input type="text" name="alt_image[{{ $lang->code }}]" class="form-control"
                                    id="alt_image" placeholder="{{ __('main.enter_alt_image') }}"
                                    value="{{ ($about) && isset($about->translate($lang->code)->alt_image) ? $about->translate($lang->code)->alt_image : '' }}">
                    ...
                    <div class="border p-3">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- Translation key for "Title Image" -->
                                <input type="text" name="title_image[{{ $lang->code }}]" class="form-control"
                                    id="title_image" placeholder="{{ __('main.enter_title_image') }}"
                                    value="{{ ($about) && isset($about->translate($lang->code)->title_image) ? $about->translate($lang->code)->title_image : '' }}">
                    ...
                    <div class="border p-3">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- Translation key for "Meta Title" -->
                    ...
                    <div class="border p-3">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- Translation key for "Meta Description" -->
                                <textarea name="meta_des[{{ $lang->code }}]" class="form-control">
                    ...
                    <div class="border p-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="des[{{ $lang->code }}]"
                                class="ckeditor">{{ ($about) && isset($about->translate($lang->code)->des) ? $about->translate($lang->code)->des : '' }}</textarea>
                            @error('des.' . $lang->code)
