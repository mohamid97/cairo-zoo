    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <form method="post" action="{{ route('data_entry.brands.update', ['id' => $brand->id]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @if($brand->image)
                                <div class="mt-3" id="old-image-container">
                                    <img src="{{ asset('uploads/images/brands/' . $brand->image) }}" alt="Image" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            @endif
