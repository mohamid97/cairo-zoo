...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div>
                <a href="{{ route('data_entry.brands.add') }}" style="color: #FFF">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <form method="GET" action="{{ route('data_entry.brands.index') }}" class="input-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                        <a href="{{ route('data_entry.brands.edit', ['id' => $brand->id]) }}">
...
@section('scripts')
    <script>
        function showDeleteBrandModal(brandId) {
            const url = `{{ url('data_entry/brands/delete') }}/${brandId}`;
