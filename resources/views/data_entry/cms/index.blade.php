...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('data_entry.cms.add') }}" style="color: #FFF">
                ...
                <div class="col-md-6">
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('data_entry.cms.index') }}" class="mb-3">
                        ...
                        @forelse($cms as $index => $blog)
                            <tr>
                                ...
                                <a href="{{ route('data_entry.cms.edit', ['id' => $blog->id]) }}">
                                    ...
                                    <!-- <a href="{{ route('data_entry.cms.destroy', ['id' => $blog->id]) }}">
...
@section('scripts')
    <script>
        function showDeleteCmsModal(cmsId) {
            const url = `{{ url('data_entry/cms/destroy') }}/${cmsId}`;
