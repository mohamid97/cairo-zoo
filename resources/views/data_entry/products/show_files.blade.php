...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div>
                <form method="post" action="{{ route('data_entry.products.files.store', ['id' => $product->id]) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="card mb-2">
                                    <div class="card-body" style="display: flex; flex-direction: column; align-items: center;">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('data_entry.products.files.delete', ['id' => $file->id]) }}" class="text-white">
