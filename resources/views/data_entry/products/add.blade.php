    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{ route('data_entry.products.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
...
{{--                        </div>--}}
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-info"> <i class="nav-icon fas fa-paper-plane"></i> {{ __('main.save') }}</button> <!-- Translated Button -->
                    </div>
