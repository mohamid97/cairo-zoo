...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div>
                <form method="post" action="{{ route('data_entry.products.props.store', ['id' => $product->id]) }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2">
                                    <div class="card-body" style="display: flex; flex-direction: column; align-items: center;">
                                        ...
                                        <div>
                                            <a href="{{ route('data_entry.products.props.delete', ['id' => $prop->id]) }}" class="text-white">
