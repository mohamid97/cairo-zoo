...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div>
                <a href="{{ route('data_entry.products.add') }}" style="color: #FFF">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('data_entry.products.index') }}" class="input-group">
                ...
                <div class="col-md-4">
                    <!-- Category Filter -->
                    <form method="GET" action="{{ route('data_entry.products.index') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center gap-2">
                                        <a href="{{ route('data_entry.products.edit', ['id' => $pro->id]) }}">
                                            <button class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"></i></button>
                                        </a>
                                        <a href="{{ route('data_entry.products.files', ['id' => $pro->id]) }}">
                                            <button class="btn btn-sm btn-success"><i class="fas fa-file"></i></button>
                                        </a>

                                        <a href="{{ route('data_entry.products.props', ['id' => $pro->id]) }}">
                                        ...
                                        <a href="{{ route('data_entry.products.gallery', ['id' => $pro->id]) }}">
...
{{--                                        <a href="{{ route('data_entry.products.soft_delete', ['id' => $pro->id]) }}">--}}
{{--                                            <button class="btn btn-sm btn-info"><i class="nav-icon fas fa-trash"></i></button>--}}
{{--                                        </a>--}}
{{--                                    @else--}}
{{--                                        <a href="{{ route('data_entry.products.restore', ['id' => $pro->id]) }}">--}}
...
{{--                                    <a href="{{ route('data_entry.products.destroy', ['id' => $pro->id]) }}">--}}
...
@section('scripts')
    <script>
        function showDeleteProductModal(productId) {
            const url = `{{ url('data_entry/products/destroy') }}/${productId}`;
